using ERMS.UI.Browsing;
using Toolbox.GUI.DX.Controls.Log;
...
namespace TestSqlBrowser
{
  partial class Form1
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.databaseBrowserControl1 = new DatabaseBrowserControl();
      this.logLister1 = new LogLister();
    ...
    private DatabaseBrowserControl databaseBrowserControl1;
    private LogLister logLister1;
