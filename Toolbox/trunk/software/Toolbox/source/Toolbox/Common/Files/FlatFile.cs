...
namespace Toolbox.Common.Files
{
	public class FileEntry
  {
    ...
    public void Inflate([NotNull] FileStream file )
    {
    ...
    public virtual void SaveToXml([NotNull] XmlElement FileElm, [NotNull] XmlDocument Doc )
    {
	    if (FileElm == null) throw new ArgumentNullException("FileElm");
    ...
    public void LoadFromXml([NotNull] XmlNode FileNode )
    {
    ...
    public void SaveFullToXml([NotNull] XmlElement FileNode, [NotNull] XmlDocument Doc )
    {
	    if (FileNode == null) throw new ArgumentNullException("FileNode");
	    if (Doc == null) throw new ArgumentNullException("Doc");
    ...
    public void LoadFullFromXml([NotNull] XmlNode FileNode )
    {
	    if (FileNode == null) throw new ArgumentNullException("FileNode");

			LoadFromXml( FileNode );
    }
  }
  ...
  public class FileChunk
  {
    ...
    public virtual void SaveToXml([NotNull] XmlElement ChunkElm, [NotNull] XmlDocument Doc )
    {
	    if (ChunkElm == null) throw new ArgumentNullException("ChunkElm");
	    if (Doc == null) throw new ArgumentNullException("Doc");
    ...
    public virtual void Inflate([NotNull] FileStream file_stream )
    {
	    if (file_stream == null) throw new ArgumentNullException("file_stream");
    ...
    public virtual void LoadFromXml([NotNull] XmlNode node, XmlDocument doc )
    {
    ...
    public virtual void SaveFullToXml([NotNull] XmlElement node_elm, [NotNull] XmlDocument doc )
    {
	    if (node_elm == null) throw new ArgumentNullException("node_elm");
	    if (doc == null) throw new ArgumentNullException("doc");
    ...
    public virtual void LoadFullFromXml([NotNull] XmlNode node, XmlDocument doc )
    {
	    if (node == null) throw new ArgumentNullException("node");
	...
	public class FlatFile : IDisposable
  {
		[NotNull] private static readonly log4net.ILog _log = log4net.LogManager.GetLogger(typeof(FlatFile));
    ...
    public BindingList<FileChunk> Chunks
    {
      get { return m_nodes; }
		...
		public bool Create([PathReference] string FilePath)
    {
      if( null != m_file )
        Close( );
      ...
      {
				_log.ErrorFormat(ex, "Create({0}): exception", FilePath);
        return false;
      }
    }
    ...
    public bool Inflate( )
    {
      ...
      {
        _log.Error("Inflate(): exception", ex);
        return false;
      }
    }

    public void Deflate( string ID, [NotNull] string TargetDir )
    {
      ...
      {
				if (!string.Equals(chunk.ID, ID, StringComparison.CurrentCultureIgnoreCase))
          continue;
      ...
      using( var fs = new FileStream( m_file_path, FileMode.Open, FileAccess.Read, FileShare.Read ) )
      {
    ...
    public void Open([NotNull] string Name, [NotNull] FileChunk ChunkType )
    {
	    if (Name == null) throw new ArgumentNullException("Name");
	    if (ChunkType == null) throw new ArgumentNullException("ChunkType");
      ...
      {
				_log.ErrorFormat(ex, "Open({0}, {1}): exception", Name, ChunkType);
      }
    }
