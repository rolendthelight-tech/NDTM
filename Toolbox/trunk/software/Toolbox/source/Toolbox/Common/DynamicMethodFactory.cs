...
namespace Toolbox.Common
{
  ...
  public static class DynamicMethodFactory
  {
    ...
    [CanBeNull]
    public static Invoker CreateInvoker([NotNull] this MethodInfo method)
    {
    ...
    [CanBeNull]
    public static FactoryMethod CreateFactoryMethod([NotNull] ConstructorInfo constructor)
    {
    ...
    [CanBeNull]
    public static Func<object, object> CreateGetter([NotNull] this FieldInfo field)
    {
    ...
    [CanBeNull]
    public static Func<object, object> CreateGetter([NotNull] this PropertyInfo property)
    {
    ...
    [CanBeNull]
    public static Action<object, object> CreateSetter([NotNull] this FieldInfo field)
    {
	    if (field == null) throw new ArgumentNullException("field");
    ...
    [CanBeNull]
    public static Action<object, object> CreateSetter([NotNull] this PropertyInfo property)
    {
	    if (property == null) throw new ArgumentNullException("property");
    ...
    private static void EmitCheckParameters([NotNull] DelegateBuildInfo info, [NotNull] ILGenerator il, int argumentArrayIndex)
    {
    ...
    /*----------------------------------------------------------------------------------------*/
    private static void EmitLoadParameters([NotNull] DelegateBuildInfo info, [NotNull] ILGenerator il, int argumentArrayIndex)
    {
	    if (info == null) throw new ArgumentNullException("info");
	    if (il == null) throw new ArgumentNullException("il");
    ...
    /*----------------------------------------------------------------------------------------*/
	  ...
	  [NotNull]
	  private static Type[] GetActualParameterTypes([NotNull] System.Reflection.ParameterInfo[] parameters)
    {
    ...
    /*----------------------------------------------------------------------------------------*/
    private static void EmitUnboxOrCast([NotNull] ILGenerator il, [NotNull] Type type)
    {
	    if (il == null) throw new ArgumentNullException("il");
	  ...
	  /*----------------------------------------------------------------------------------------*/
    private static void EmitLoadInt([NotNull] ILGenerator il, int value)
    {
	    if (il == null) throw new ArgumentNullException("il");
	  ...
	  /*----------------------------------------------------------------------------------------*/
    private static void EmitLoadArg([NotNull] ILGenerator il, int index)
    {
	    if (il == null) throw new ArgumentNullException("il");
    ...
    private class DelegateBuildInfo
    {
      ...
      public DelegateBuildInfo([NotNull] ConstructorInfo ctor)
      {
      ...
      public DelegateBuildInfo([NotNull] MethodInfo method)
      {
	      if (method == null) throw new ArgumentNullException("method");
