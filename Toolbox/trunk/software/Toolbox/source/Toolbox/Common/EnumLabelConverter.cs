...
namespace Toolbox.Common
{
  ...
  public class EnumLabelConverter : EnumConverter
  {
    ...
    public EnumLabelConverter([NotNull] Type type)
      : base(type)
    {
      if (type == null)
      ...
      if (!type.IsEnum)
				throw new ArgumentException("¬type.IsEnum", "type");
    ...
    public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
    {
      if (value is string)
      {
        object ret = EnumExtensions.ParseEnumLabel(m_type, value as string);
