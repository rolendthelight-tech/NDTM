...
namespace Toolbox.Configuration
{
  public class DataContractConfigurator : IConfigurator
  {
    ...
    public DataContractConfigurator([NotNull] IConfigFile file)
    {
      if (file == null)
      ...
      m_file = file;
		...
		public DataContractConfigurator([NotNull] [PathReference] string fileName) :
      this(new ConfigFile(fileName))
    {
	    if (fileName == null) throw new ArgumentNullException("fileName");
    }

	  public bool LoadSection([NotNull] Type sectionType, [NotNull] InfoBuffer buffer)
    {
      if (sectionType == null)
    ...
    public void SaveSettings()
    {
	  ...
	  [NotNull]
	  private ConfigurationSection CreateSection([NotNull] Type sectionType) 
    {
    ...
    private void LogException([NotNull] Exception ex)
    {
	  ...
	  [NotNull]
	  private static string GetSectionName([NotNull] Type sectionType, out bool data_contract)
    {
	    if (sectionType == null) throw new ArgumentNullException("sectionType");
      ...
      if (data_contract)
      {
				//var contract = (DataContractAttribute) sectionType.GetCustomAttributes(typeof (DataContractAttribute), false)[0];
