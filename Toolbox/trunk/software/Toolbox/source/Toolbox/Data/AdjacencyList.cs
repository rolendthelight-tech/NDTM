...
namespace Toolbox.Data
{
  ...
  public class AdjacencyList<TNode, TEdge>
  {
    ...
    private readonly LockSource m_lock = new LockSource();
	  [NotNull] private readonly Dictionary<TNode, Dictionary<TNode, TEdge>> m_data = new Dictionary<TNode, Dictionary<TNode, TEdge>>();
    private HashSet<EdgeInfo<TNode, TEdge>> m_edges;

	  [NotNull] private static readonly ILog _log = LogManager.GetLogger(string.Format("AdjacencyList<{0}, {1}>",
    ...
    public TEdge this[TNode fromNode, TNode toNode]
    {
      ...
      set
      {
		...
		private void FindAdjacency([NotNull] TNode fromNode, [NotNull] TNode toNode, out Dictionary<TNode, TEdge> from_edges, out Dictionary<TNode, TEdge> to_edges)
    {
      if (fromNode == null)
        throw new ArgumentNullException("fromNode");
      if (toNode == null)
        throw new ArgumentNullException("toNode");
			...
			if (!m_data.TryGetValue(fromNode, out from_edges))
				throw new ArgumentException("Graph node not found", "fromNode");
			if (!m_data.TryGetValue(toNode, out to_edges))
				throw new ArgumentException("Graph node not found", "toNode");
		}
    ...
    /// <param name="node">Вершина</param>
		public void AddNode([NotNull] TNode node)
    {
      if (node == null)
    ...
    /// <returns><code>true</code>, если вершина была удалена. <code>false</code>, если вершина не была найдена</returns>
		public bool RemoveNode([NotNull] TNode node)
    {
			if (node == null)
				throw new ArgumentNullException("node");
    ...
    /// <param name="edge">Вес создаваемой дуги</param>
		public void AddEdge([NotNull] TNode fromNode, [NotNull] TNode toNode, TEdge edge)
    {
			if (fromNode == null)
				throw new ArgumentNullException("fromNode");
    ...
    public void AddEdge([NotNull] EdgeInfo<TNode, TEdge> edge)
    {
      if (edge == null)
    ...
    /// <param name="toNode">Конечная вершина в дуге</param>
    /// <param name="edge">Вес создаваемой дуги</param>
    /// <returns><code>true</code>, если дуга была создана. <code>false</code>, если дуга была обновлена</returns>
		public bool SetEdge([NotNull] TNode fromNode, [NotNull] TNode toNode, TEdge edge)
    {
			if (fromNode == null)
				throw new ArgumentNullException("fromNode");
    ...
    /// <param name="edge">Сведения о дуге</param>
    /// <returns><code>true</code>, если дуга была создана. <code>false</code>, если дуга была обновлена</returns>
    public bool SetEdge([NotNull] EdgeInfo<TNode, TEdge> edge)
    {
      if (edge == null)
        throw new ArgumentNullException("edge");
    ...
    /// <returns><code>true</code>, если ребро было удалено. <code>false</code>, если ребро не найдено</returns>
		public bool RemoveEdge([NotNull] TNode fromNode, [NotNull] TNode toNode)
    {
			if (fromNode == null)
				throw new ArgumentNullException("fromNode");
    ...
    /// <param name="fromNode">Начальная вершиина ребра</param>
    /// <param name="toNode">Конечная вершаина ребра</param>
    /// <returns><code>true</code>, если ребро найдено. Иначе, <code>false</code></returns>
		public bool ContainsEdge([NotNull] TNode fromNode, [NotNull] TNode toNode)
    {
			if (fromNode == null)
				throw new ArgumentNullException("fromNode");
    ...
    /// <returns>Количество рёбер</returns>
		public int GetOutgoingEdgeCount([NotNull] TNode node)
    {
			if (node == null)
				throw new ArgumentNullException("node");
    ...
    /// <param name="node">Вершина</param>
    /// <returns>Количество рёбер</returns>
		public int GetIncomingEdgeCount([NotNull] TNode node)
    {
			if (node == null)
				throw new ArgumentNullException("node");
    ...
    {
      if (!m_oriented)
				throw new InvalidOperationException("¬m_oriented");
    ...
    [NotNull]
    public List<AdjacencyList<TNode, TEdge>> GetOutgoingChains([NotNull] TNode startNode)
    {
			if (startNode == null)
    ...
    [NotNull]
    public List<List<TNode>> GetOutgoingChainNodes([NotNull] TNode startNode)
    {
			if (startNode == null)
				throw new ArgumentNullException("startNode");
    ...
    /// <returns>Список цепочек вершин, исходящих из указанной вершины</returns>
    [NotNull]
    public List<List<TNode>> GetOutgoingChainNodes([NotNull] TNode startNode, int maxNodeCount)
    {
			if (startNode == null)
				throw new ArgumentNullException("startNode");
  ...
  public class EdgeInfo<TNode, TEdge>
  {
    ...
    private readonly TEdge m_edge;
		...
		public EdgeInfo([NotNull] TNode fromNode, [NotNull] TNode toNode, TEdge edge)
    {
      if (fromNode == null)
        throw new ArgumentNullException("fromNode");
