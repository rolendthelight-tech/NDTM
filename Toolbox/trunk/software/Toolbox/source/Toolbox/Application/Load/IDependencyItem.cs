...
namespace Toolbox.Application.Load
{
  ...
  public class TopologicalSort<T>
  {
    private readonly Dictionary<T, IDependencyItem<T>> m_dependency_items;
	  [NotNull] private readonly List<T> m_sorted_keys = new List<T>();
    ...
    public TopologicalSort([NotNull] ICollection<IDependencyItem<T>> dependencyItems)
    {
    ...
    private void ProcessItem([NotNull] HashSet<T> addedKeys, T key, bool optional)
    {
    ...
    private void CheckRecursion(T key, [NotNull] HashSet<T> chain)
    {
