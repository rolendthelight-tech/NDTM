...
namespace Toolbox.GUI.DX.Dialogs
{
  ...
  {
	  [NotNull] private static readonly log4net.ILog Log = log4net.LogManager.GetLogger(typeof(MultiEditForm));

    protected bool m_loading = true;
    protected readonly List<string> m_edited = new List<string>();
    protected GridView m_view = null;
    protected readonly List<string> m_except_fields = new List<string>();
    ...
    private void HandleEditChanged([NotNull] object sender, [NotNull] DevExpress.XtraVerticalGrid.Events.RowChangedEventArgs e)
    {
