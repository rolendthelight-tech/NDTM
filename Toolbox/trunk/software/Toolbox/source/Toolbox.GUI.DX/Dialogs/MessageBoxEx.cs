...
namespace Toolbox.GUI.DX.Dialogs
{
  ...
  public partial class MessageBoxEx : LocalizableForm
  {
      ...
      set
      {
        ...
        switch (value)
        {
          case Icons.Error:
            ...
            break;
          case Icons.Warning:
						m_picture.Image = Toolbox_GUI_Resources.p_48_warning;
            break;
          case Icons.Question:
            m_picture.Image = Resources.p_48_question;
            break;
          case Icons.Information:
            m_picture.Image = Toolbox_GUI_Resources.p_48_info;
            break;
          case Icons.Stop:
    ...
    {
      // Fix для корректной установки клавиши по умолчанию — иначе всегда ставится Cancel
      Buttons = Buttons;
    ...
    public static void ShowError(string message, IWin32Window parent)
    {
	    ...
	    {
		    box.Caption = Resources.FAIL;
		    box.StandardIcon = Icons.Error;
		    box.Message = message;
		    box.Buttons = MessageBoxButtons.OK;
    ...
    public static void ShowInfo(string message, IWin32Window parent)
    {
	    using (var box = new MessageBoxEx())
	    {
		    box.Caption = Resources.INFO_TITLE;
		    box.StandardIcon = Icons.Information;
		    box.Message = message;
		    box.Buttons = MessageBoxButtons.OK;
		    box.StartPosition = FormStartPosition.CenterParent;
