namespace Toolbox.GUI.DX.Dialogs
{
	partial class SettingsForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.navBarItem1.LargeImage = global::Toolbox.GUI.DX.Properties.Resources.p_32_log_config;
      this.navBarItem1.Name = "navBarItem1";
			this.navBarItem1.SmallImage = global::Toolbox.GUI.DX.Properties.Resources.p_32_log_config;
      // 
      // m_cancel_btn
      // 
      ...
      // 
      this.settingErrorBindingSource.DataSource = typeof(SettingsForm.SettingError);
      // 
      // gridView1
      // 
      ...
      // SettingsForm
      // 
      this.CancelButton = m_cancel_btn;
