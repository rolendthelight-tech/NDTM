...
namespace Toolbox.GUI.DX.Dialogs
{
  ...
  public partial class AboutBox : LocalizableForm
  {
    ...
    {
      if (this.Owner != null)
        m_main_group.Text = string.Format("{0}  {1}", Resources.ABOUT_TITLE, this.Owner.Text);
    ...
    {
      m_main_group.Text = string.Format("{0}  {1}", Resources.ABOUT_TITLE, ApplicationInfo.MainAttributes.ProductName);
      m_copyright.Text = string.Format("{0}  {1}", ApplicationInfo.MainAttributes.Copyright, ApplicationInfo.MainAttributes.Company);
      m_version.Text = string.Format("{0}  {1}", Resources.VERSION_TITLE, ApplicationInfo.MainAttributes.Version);
