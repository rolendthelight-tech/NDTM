...
namespace Toolbox.GUI.DX.Dialogs
{
  partial class InfoListForm
  {
    ...
    private void InitializeComponent()
    {
        ...
        this.m_lister = new InfoTreeView();
        ...
        this.m_panel_dragger = new GroupControlDragger(this.components);
    ...
    private GroupControlDragger m_panel_dragger;
  }
}
