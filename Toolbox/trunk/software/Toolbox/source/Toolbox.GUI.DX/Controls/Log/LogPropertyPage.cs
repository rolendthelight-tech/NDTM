...
namespace Toolbox.GUI.DX.Controls.Log
{
	public partial class LogPropertyPage : PropertyPage 
  {
    ...
    private void m_log_level_edit_ParseEditValue([NotNull] object sender, [NotNull] DevExpress.XtraEditors.Controls.ConvertEditValueEventArgs e)
    {
    ...
    private void m_log_level_edit_FormatEditValue([NotNull] object sender, [NotNull] DevExpress.XtraEditors.Controls.ConvertEditValueEventArgs e)
    {
	    if (sender == null) throw new ArgumentNullException("sender");
	    if (e == null) throw new ArgumentNullException("e");
