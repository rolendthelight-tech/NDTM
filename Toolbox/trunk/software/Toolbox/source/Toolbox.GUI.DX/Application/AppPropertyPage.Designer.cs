...
namespace Toolbox.GUI.DX.Application
{
  partial class AppPropertyPage
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.m_close_on_critical_error = new DevExpress.XtraEditors.CheckEdit();
      ...
      ((System.ComponentModel.ISupportInitialize)(this.m_close_on_critical_error.Properties)).BeginInit();
      ...
      // 
      this.settingsBindingSource.DataSource = typeof(ApplicationSettings);
      // 
      ...
      this.groupControl1.Controls.Add(this.m_close_on_critical_error);
      ...
      // 
      // m_close_on_critical_error
      // 
      this.m_close_on_critical_error.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.settingsBindingSource, "CloseOnCriticalError", true));
      this.m_close_on_critical_error.Location = new System.Drawing.Point(149, 107);
      this.m_close_on_critical_error.Name = "m_close_on_critical_error";
      this.m_close_on_critical_error.Properties.Caption = "Close after critical failure";
      this.m_close_on_critical_error.Size = new System.Drawing.Size(347, 18);
      this.m_close_on_critical_error.TabIndex = 8;
      // 
      // groupControl2
      // 
      ...
      this.errorBoxBindingSource.DataSource = typeof(Toolbox.GUI.DX.Dialogs.ErrorBox.Settings);
      // 
      // AppPropertyPage
      // 
      ...
      ((System.ComponentModel.ISupportInitialize)(this.m_close_on_critical_error.Properties)).EndInit();
    ...
    private DevExpress.XtraEditors.CheckEdit m_close_on_critical_error;
